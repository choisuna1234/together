...
public class BoardController {
	...
	// 관리자 멍멍왈왈 게시판 띄워주기만 하는 리스트
		...
		public ModelAndView adminBoardDetail(@PathVariable("BC_IDX") int BC_IDX, CommandMap commandMap) throws Exception {
		...
		//게시글 삭제하기
		@RequestMapping(value = "/admin/board/delete", method = RequestMethod.POST )//RedirectAttributes 클래스를 이용해 삭제 후 alert창 띄우기 
		public ModelAndView adminBoardDelete(CommandMap commandMap, RedirectAttributes redirect) throws Exception {
			...
			redirect.addFlashAttribute("글 삭제가 완료되었습니다");
			return mv;
		}
